...
class Errors extends Equatable {
  ...
  factory Errors.fromMap(Map<String, dynamic> map) {
    return Errors(
      ...
      title:
      map['title'] != null ? List<String>.from(map['title'].map((x) => x)) : [],

      slug:
      map['slug'] != null ? List<String>.from(map['slug'].map((x) => x)) : [],

      propertytypeId:
      map['property_type_id'] != null ? List<String>.from(map['property_type_id'].map((x) => x)) : [],

      purpose:
      map['purpose'] != null ? List<String>.from(map['purpose'].map((x) => x)) : [],

      price:
      map['price'] != null ? List<String>.from(map['price'].map((x) => x)) : [],

      description:
      map['description'] != null ? List<String>.from(map['description'].map((x) => x)) : [],

      cityId:
      map['city_id'] != null ? List<String>.from(map['city_id'].map((x) => x)) : [],

      addressDescription:
      map['address_description'] != null ? List<String>.from(map['address_description'].map((x) => x)) : [],


      googleMap:
      map['google_map'] != null ? List<String>.from(map['google_map'].map((x) => x)) : [],

      totalArea:
      map['total_area'] != null ? List<String>.from(map['total_area'].map((x) => x)) : [],

      totalUnit:
      map['total_unit'] != null ? List<String>.from(map['total_unit'].map((x) => x)) : [],

      totalBedroom:
      map['total_bedroom'] != null ? List<String>.from(map['total_bedroom'].map((x) => x)) : [],

      totalBathroom:
      map['total_bathroom'] != null ? List<String>.from(map['total_bathroom'].map((x) => x)) : [],

      totalGarage:
      map['total_garage'] != null ? List<String>.from(map['total_garage'].map((x) => x)) : [],

      totalKitchen:
      map['total_kitchen'] != null ? List<String>.from(map['total_kitchen'].map((x) => x)) : [],

      thumbnailImage:
      map['thumbnail_image'] != null ? List<String>.from(map['thumbnail_image'].map((x) => x)) : [],
